...
export const useFilterChangeNotifications: (
	resultsPayload: { results: Word[]; resultsHash: string; onResultsChanged: FilterBarProps['onResultsChanged'] },
	meaningPayload: { checked: boolean; onHideMeaningChanged: FilterBarProps['onHideMeaningChanged'] },
	pinyinPayload: { checked: boolean; onHidePinYinChanged: FilterBarProps['onHidePinYinChanged'] }
